...
.nav{background:rgba(247,238,232,0.97);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-bottom:0.5px solid var(--bo);padding:0 52px;height:64px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:100;animation:fadeIn 0.4s ease}
.n-logo{text-decoration:none;display:flex;align-items:center;flex-shrink:0;}
.n-logo img{height:54px;width:54px;object-fit:cover;border-radius:50%;border:2px solid var(--bo);transition:box-shadow 0.2s;}
.n-logo img:hover{box-shadow:0 4px 12px rgba(194,112,128,0.3);}
.n-links{display:flex;gap:0}
.n-links a{font-size:11.5px;font-weight:500;color:var(--mu);text-decoration:none;padding:0 14px;height:64px;display:flex;align-items:center;border-bottom:2px solid transparent;transition:color 0.2s,border-color 0.2s;letter-spacing:0.1px;white-space:nowrap;}
.n-links a:hover{color:var(--dk)}
.n-links a.act{color:var(--r);font-weight:600;border-bottom:2px solid var(--r)}
.n-right{display:flex;align-items:center;gap:8px;flex-shrink:0;}
.n-av{width:32px;height:32px;background:var(--r);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#fff;cursor:pointer;transition:transform 0.2s,box-shadow 0.2s;text-decoration:none;flex-shrink:0;}
.n-av:hover{transform:scale(1.05);box-shadow:0 4px 12px rgba(194,112,128,0.4)}
.n-signout{background:none;border:0.5px solid var(--bo);color:var(--mu);padding:6px 14px;font-size:11px;font-weight:600;cursor:pointer;font-family:inherit;letter-spacing:0.3px;transition:all 0.2s;}
.n-signout:hover{border-color:var(--r);color:var(--r);}
...
.f-logo{text-decoration:none;display:flex;align-items:center;justify-content:center;}
.f-logo img{height:46px;width:46px;object-fit:cover;border-radius:50%;border:2px solid rgba(255,255,255,0.15);}
...
<nav class="nav">
  <a class="n-logo" href="{{ route('landing') }}">
    <img src="{{ asset('images/logo(2).png') }}" alt="EZParcel">
  </a>
  ...
  <div class="n-right">
    ...
    <form method="POST" action="{{ route('logout') }}" style="margin:0">
      @csrf
      <button type="submit" class="n-signout">Sign Out</button>
    </form>
  </div>
  @endauth
...
<footer class="footer">
  ...
  <div style="font-size:11px;color:rgba(251,248,245,0.35);line-height:1.8;margin-top:6px;">
